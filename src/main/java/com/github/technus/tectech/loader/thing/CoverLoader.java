...
public class CoverLoader implements Runnable {
    public void run() {
        ...
        GregTech_API.registerCover(new ItemStack(TeslaCoilCover.INSTANCE, 1, 0), TextureFactory.of(TESLA_OVERLAY), new GT_Cover_TM_TeslaCoil());
        GregTech_API.registerCover(new ItemStack(TeslaCoilCover.INSTANCE, 1, 1), TextureFactory.of(TESLA_OVERLAY_ULTIMATE), new GT_Cover_TM_TeslaCoil_Ultimate());
        GregTech_API.registerCover(new ItemStack(EnderFluidLinkCover.INSTANCE, 1, 0), TextureFactory.of(ENDERFLUIDLINK_OVERLAY), new GT_Cover_TM_EnderFluidLink());
        GregTech_API.registerCover(new ItemStack(PowerPassUpgradeCover.INSTANCE, 1, 0), TextureFactory.of(POWERPASSUPGRADE_OVERLAY), new GT_Cover_TM_PowerPassUpgrade());
