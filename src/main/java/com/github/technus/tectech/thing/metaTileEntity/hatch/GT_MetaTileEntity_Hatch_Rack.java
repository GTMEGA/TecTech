...
//        new RackComponent(ItemList.Circuit_Wetwaremainframe.get(1), 38, 25, -.4F, 6000, true);//UHV Circuit
        ...
        if (Loader.isModLoaded(Reference.HTX)) {
            new RackComponent("htx:item.hvcpucircuit", 3, 2, -.1f, 9001, true);
            new RackComponent("htx:item.evcpucircuit", 24, 16, -.25f, 10000, true);
            new RackComponent("htx:item.ivcpucircuit", 48, 35, -.45f, 8000, true);
            new RackComponent("htx:item.luvcpucircuit", 64, 40, -.5f, 8500, true);
            new RackComponent("htx:item.zpmcpucircuit", 128, 48, -.6f, 9000, true);
        }
